...
class Trapezoidal extends React.Component {
    constructor(props) {
        ...
        this.Trapezoidal=this.Trapezoidal.bind(this); //ประกาศฟังก์ชัน Trapezoidal
    }
    handleChange(event) {
    ...
    handleSubmit(event) {
        ...
        if((str.length!==0)&&(c!==0)&&this.state.submitted&&this.state.a!==""&&this.state.b!==""){ //เช็คความยาวสมการต้องไม่เท่ากับ 0 และ c ที่เช็ค x ต้องไม่เท่ากับ 0 และ xl xr ต้องไม่ใช่ค่าว่าง
          axios
          .post("http://localhost:8000/Trapezoidal/Trapezoidal", {
          ...
          this.Trapezoidal(); //ส่งไปที่ฟังก์ชัน FWOH
