...
class Gauss extends Component{
    ...
    Gauss(event) {
        this.initMatrix();
        for(let i=0;i<this.state.variable-1;i++){
            for(let j=i+1;j<this.state.variable;j++){
                var ratio=A[j][i]/A[i][i];
                for(let k=i+1;k<this.state.variable;k++){
                      ...
                      <div id="M">
                          ...
                          <div className="field has-addons">
                              <div className="control">
                                  <button type="submit" value="Submit" onClick={this.Gauss}>Submit</button>
                              </div>
                          </div>
                      </div>
                    }
